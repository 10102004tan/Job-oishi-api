<x-layout>
    ...
    <form action="{{ route('jobs.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="job_type_str" name="job_type_str">
            @error('job_type_str')
            <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="mb-3 form-check d-flex">
            ...
            <div class="col-4">
                ...
                <input type="checkbox" class="form-check-input" id="is_salary_value" name="is_salary_value" value="1">
            </div>
            <div class="col-4">
                <label for="is_applied" class="form-check-label">Is Applied</label>
                <input type="hidden" name="is_applied" value="0">
                <input type="checkbox" class="form-check-input" id="is_applied" name="is_applied" value="1">
            </div>
        </div>
